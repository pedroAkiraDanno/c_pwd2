...
#define CHUNK_SIZE 10 // Number of elements to process at once
#define RANDOM_RANGE 100 // Random renge 
...
void generateRandomData() {
    ...
    for (int i = 0; i < CHUNK_SIZE * 10; i++) {
        int randomValue = rand() % RANDOM_RANGE + 1;
        fprintf(file, "%d\n", randomValue);
    }
...
int main() {
    ...
    scanf("%d", &num);
    int result = binarySearchInSortedFile(sortedFile, num, fileSize);  
