...
void generateRandomData(long* arr, long size) {
    for(long i = 0; i < size; i++) {
        arr[i] = rand() % 1000000000; // Generate random numbers between 0 and 999999999
    }
}
...
int main() {
    long size = 100000000; // Define your desired size
    ...
    long target = 420000000; // Define your desired target for binary search
